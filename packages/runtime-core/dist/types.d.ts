 ...
 */
export type ProtocolVerb = "#us#.task.plan" | "#us#.task.assign" | "#us#.artifact.produce" | "#us#.evaluation.score" | "#us#.execution.complete";
...
export type StepType = "plan" | "assign" | "artifact_produce" | "evaluation" | "produce_artifact" | "evaluate" | "human_approval" | "complete";
export type StepStatus = "pending" | "ready" | "executing" | "awaiting_human" | "completed" | "failed" | "blocked" | "skipped";
...
export type EnvelopeStatus = "created" | "leased" | "planned" | "executing" | "awaiting_human" | "approved" | "completed" | "rejected" | "failed" | "quarantined";
export type AggregationStrategy = "merge_in_order" | "sectioned_report" | "summary_of_summaries";
