...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white tech-grid scanline" suppressHydrationWarning>
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center gap-6 animate-in fade-in zoom-in duration-1000">
              <img
                src="/ace-symbol.png"
                alt="ACEPLACE Symbol"
                className="w-16 h-16 object-contain drop-shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all duration-500 hover:scale-110 hover:drop-shadow-[0_0_30px_rgba(6,182,212,0.5)] cursor-target"
              />
              <div className="flex flex-col items-center">
                ...
                <p className="text-cyan-500/60 font-mono text-[9px] md:text-[10px] tracking-[0.4em] font-black uppercase mt-1">
            ...
            <h2 className="text-sm md:text-base text-slate-400 font-bold max-w-xl mx-auto leading-relaxed uppercase tracking-tight italic">
              Human governance for autonomous agents with <span className="text-white">deterministic identity</span> and{" "}
              <span className="text-cyan-500">high-fidelity orchestration</span>.
            </h2>
          </div>
            ...
            {[
              {
                icon: Shield,
                title: "Governance",
                desc: "Strict human-in-the-loop approval workflows.",
                color: "text-cyan-400",
              },
              {
                icon: Zap,
                title: "Agility",
                desc: "Fast agent dispatch and real-time lifecycle tracking.",
                color: "text-purple-400",
              },
              {
                icon: Globe,
                title: "Persistence",
                desc: "Identity persistence and state synchronization across nodes.",
                color: "text-blue-400",
              },
            ].map((feature) => (
              <div
                key={feature.title}
                className="glass p-8 scifi-clip border border-white/5 space-y-4 group hover:border-white/20 transition-all cursor-target"
              >
      ...
      <section id="learn-more" className="relative bg-[#05070a] border-t border-white/5 scroll-mt-0">
        <AboutContent />
        <div className="flex flex-col items-center gap-6 pb-20 pt-8 border-t border-white/5">
          <Link
            href="/dashboard"
            className="group px-16 py-6 bg-cyan-500 hover:bg-cyan-400 text-black font-black text-xl uppercase tracking-[0.2em] transition-all shadow-[0_0_50px_rgba(6,182,212,0.3)] hover:shadow-[0_0_70px_rgba(6,182,212,0.6)] active:scale-95 scifi-clip flex items-center gap-3 cursor-target"
          >
